package com.sba.ppp.loanforgiveness.util;
...
public class DateUtils {
	...
	public static Date formatDate(String subDateStr, String format) {
		Date subDate = null;
		SimpleDateFormat formatter = new SimpleDateFormat(format);
		try {
			subDate = (Date) formatter.parse(subDateStr);
		} catch (ParseException e1) {
			log.error("Submission Date format Error. Date: ", subDateStr);
		}
		return subDate;
	}
